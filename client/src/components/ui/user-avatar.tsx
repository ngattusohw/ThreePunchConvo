    ...
    return (
      <div className={cn("relative", className)}>
        <img
          ...
          className={cn(
            sizeClasses[size],
            "border-ufc-red rounded-full border-2 object-cover",
          )}
        />
        <div
          className={cn(
            verifiedIndicatorSizeClasses[size],
            "bg-ufc-red text-ufc-black border-dark-gray absolute flex items-center justify-center rounded-full",
          )}
        >
          <svg
            xmlns='http://www.w3.org/2000/svg'
      ...
      <img
        ...
        className={cn(
          ...
          user?.status === "HALL OF FAMER" ||
            ...
            ? "border-ufc-admin-yellow border-2"
            : "",
        )}
      />
