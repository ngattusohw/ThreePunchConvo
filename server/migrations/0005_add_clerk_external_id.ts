...
export async function down(db: any) {
  console.log("Running down migration: Remove external_id column from users table");
  ...
  console.log("Down migration completed: Removed external_id column from users table");
} 