...
export async function down(db: any) {
  console.log("Running down migration: Remove stripe_id column from users table");
  ...
  console.log("Down migration completed: Removed stripe_id column from users table");
} 